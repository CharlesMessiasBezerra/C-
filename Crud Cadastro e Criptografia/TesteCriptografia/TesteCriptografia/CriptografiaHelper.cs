...
namespace TesteCriptografia
{
    public static class CriptografiaHelper
    {
        ...
        public static string Encriptar(
            string chave, string vetorInicializacao, string textoNormal)
        {
                ...
                chave, vetorInicializacao))
            {
                ...
                using (MemoryStream streamResultado = new MemoryStream())
                {
                    using (CryptoStream csStream = new CryptoStream(
                        streamResultado, encryptor, CryptoStreamMode.Write))
                    {
        ...
        public static string Decriptar(
            string chave, string vetorInicializacao, string textoEncriptado)
        {
                ...
                chave, vetorInicializacao))
            {
                ...
                {
                    using (CryptoStream csStream = new CryptoStream(
                        streamTextoEncriptado, decryptor, CryptoStreamMode.Read))
                    {
